...
public class customerAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String username = intent.getStringExtra("username");
         txtViewUsername = (EditText) findViewById(R.id.txtViewUsername);
        ...
        btnDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(customerAppointment.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btnTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(customerAppointment.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
    ...
    public void onAddAppointments(View view) {
        ...
        if (userName.equals("") || time.equals("") || date.equals("")) {
            ...
            Toast.makeText(customerAppointment.this, "Error! Fields Can't Be Blank!", Toast.LENGTH_LONG).show();
